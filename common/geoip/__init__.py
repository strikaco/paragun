...
class GeoIP(DjangoGeoIP2):
    ...
    def cidr(self, query):
        ...
        try:
            ...
            logger.error('GeoIP: CIDR data requested, but no database was configured.')
            return {}
    ...
    def country(self, query):
        try:
            ...
            logger.error('GeoIP: %s' % e)
            return None
            
    def city(self, query):
        try:
            geo = super(GeoIP, self).city(query)
            if not geo: return {}
    ...
    def isp(self, query):
        ...
        try:
            ...
            logger.error('GeoIP: ASN/ISP data requested, but no database was configured.')
            return None
